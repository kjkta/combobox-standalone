...
exports.ComboboxButton = exports.ComboboxOption = exports.ComboboxList = exports.ComboboxPopover = exports.ComboboxInput = exports.Combobox = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _on, _on2, _on3, _on4, _states; /* eslint-disable jsx-a11y/role-has-required-aria-props */
...
var _popover = require("@reach/popover");
...
var Combobox = (0, _react.forwardRef)(function Combobox(_ref, ref) {
  var onSelect = _ref.onSelect,
      ...
      rest = _objectWithoutProperties(_ref, ["onSelect", "onHighlightChange", "openOnFocus", "children", "as"]);
  ...
  // about this one too!
  var autocompletePropRef = (0, _react.useRef)();

  var persistSelectionRef = (0, _react.useRef)();
...
process.env.NODE_ENV !== "production" ? Combobox.propTypes = { onSelect: _propTypes.func } : void 0;

////////////////////////////////////////////////////////////////////////////////
// ComboboxInput

var ComboboxInput = (0, _react.forwardRef)(function ComboboxInput(_ref2, forwardedRef) {
  var _ref2$as = _ref2.as,
      Comp = _ref2$as === undefined ? "input" : _ref2$as,
      _ref2$selectOnClick = _ref2.selectOnClick,
      selectOnClick = _ref2$selectOnClick === undefined ? false : _ref2$selectOnClick,
      ...
      props = _objectWithoutProperties(_ref2, ["as", "selectOnClick", "autocomplete", "onClick", "onChange", "onKeyDown", "onBlur", "onFocus", "value"]);
...
var ComboboxPopover = (0, _react.forwardRef)(function ComboboxPopover(_ref3, forwardedRef) {
  ...
  var Container = portal ? _popover2.default : "div";

  var popupProps = portal ? {
    targetRef: inputRef,
    position: _popover.positionMatchWidth
  } : null;
...
var ComboboxList = (0, _react.forwardRef)(function ComboboxList(_ref4, ref) {
  var _ref4$persistSelectio = _ref4.persistSelection,
      persistSelection = _ref4$persistSelectio === undefined ? false : _ref4$persistSelectio,
      _ref4$as = _ref4.as,
  ...
  return _react2.default.createElement(Comp, _extends({}, props, { ref: ref, "data-reach-combobox-list": "", role: "listbox" }));
});
...
var ComboboxOption = (0, _react.forwardRef)(function ComboboxOption(_ref5, ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement("li", _extends({}, props, {
      ...
      , tabIndex: "-1",
      onClick: (0, _utils.wrapEvent)(onClick, handleClick),
      children: children || _react2.default.createElement(ComboboxOptionText, null)
    }))
  );
});
...
function ComboboxOptionText() {
  ...
  var searchWords = (0, _escapeRegexp2.default)(contextValue).split(/\s+/);
  var textToHighlight = value;
  var results = (0, _react.useMemo)(function () {
    return (0, _highlightWordsCore.findAll)({ searchWords: searchWords, textToHighlight: textToHighlight });
...
////////////////////////////////////////////////////////////////////////////////
// ComboboxButton
var ComboboxButton = (0, _react.forwardRef)(function ComboboxButton(_ref6, _ref7) {
  ...
  return _react2.default.createElement(Comp, _extends({
    ...
    ref: function ref(node) {
      ...
      (0, _utils.assignRef)(buttonRef, node);
    },
    onClick: (0, _utils.wrapEvent)(onClick, handleClick),
    onKeyDown: (0, _utils.wrapEvent)(onKeyDown, handleKeyDown)
  }, props));
...
function useReducerMachine(chart, reducer, initialData) {
  var _useState = (0, _react.useState)(chart.initial),
      state = _useState[0],
  ...
  var transition = function transition(action) {
    ...
    dispatch(_extends({ type: action, state: state, nextState: state }, payload));
    setState(nextState);
  };
