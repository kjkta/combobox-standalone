...
export { Combobox };
process.env.NODE_ENV !== "production" ? Combobox.propTypes = { onSelect: func } : void 0;
...
var ComboboxList = forwardRef(function ComboboxList(_ref4, ref) {
  ...
  return React.createElement(Comp, _extends({}, props, { ref: ref, "data-reach-combobox-list": "", role: "listbox" }));
});
...
export function ComboboxOptionText() {
  ...
  var searchWords = escapeRegexp(contextValue).split(/\s+/);
  var textToHighlight = value;
  var results = useMemo(function () {
    return findAll({ searchWords: searchWords, textToHighlight: textToHighlight });
